...
namespace Hermany.AoC.Tests._2017._17
{
    [TestClass]
    public class Test
    {
        public ISolution CreateSolution() =>
            new AoC._2017._17.Solution();
        ...
        public void Part1SampleInput()
        {
            ...
            Assert.AreEqual("638", solution.Part1(input));
        }
        ...
        public void Part1PuzzleInput()
        {
            ...
            Assert.AreEqual("596", solution.Part1(input));
        }
        ...
        public void Part2SampleInput()
        {
            var solution = CreateSolution();
            var input = Program.GetPuzzleInput(solution, "input.sample.txt");
            Assert.AreEqual("1222153", solution.Part2(input));
        }
        ...
        public void Part2PuzzleInput()
        {
            var solution = CreateSolution();
            var input = Program.GetPuzzleInput(solution);
            Assert.AreEqual("39051595", solution.Part2(input));
        }
    }
}
